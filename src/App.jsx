...
const INNER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(9,14,27,0.98)_0%,rgba(20,27,45,0.94)_55%,rgba(53,34,42,0.92)_100%)]";
...
const gradientOuterCard = `rounded-[2rem] border border-[rgba(199,224,211,0.12)] ${OUTER_GRADIENT} md:backdrop-blur-2xl backdrop-blur-md shadow-[0_16px_50px_rgba(0,0,0,0.30)]`;
...
function sectionBadge(icon, text, textColor = "text-white") {
  ...
  return (
    <div
      className={`inline-flex max-w-full items-center gap-3 rounded-full border border-[rgba(199,224,211,0.16)] bg-[rgba(255,255,255,0.08)] px-4 py-2.5 text-xs font-semibold ${textColor} backdrop-blur-md shadow-[0_12px_26px_rgba(0,0,0,0.22)] sm:px-5 sm:py-3 sm:text-sm`}
    >
...
function LargeSectionBadge({ icon: Icon, text }) {
  return (
    <div
      className="inline-flex max-w-full items-center gap-3 rounded-full border border-[rgba(199,224,211,0.14)] bg-[linear-gradient(135deg,rgba(255,255,255,0.09),rgba(255,255,255,0.04))] px-5 py-3 text-base font-bold backdrop-blur-md shadow-[0_12px_30px_rgba(0,0,0,0.24)] sm:px-8 sm:py-4 sm:text-xl lg:text-2xl"
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.45rem] border border-[rgba(199,224,211,0.14)] bg-[rgba(14,26,22,0.76)] p-3 sm:p-4 shadow-[0_18px_40px_rgba(0,0,0,0.25)]">
      <audio
        ref={audioRef}
        preload="metadata"
      ...
      <div className="mb-4 flex h-14 items-end gap-[2px] overflow-hidden rounded-2xl border border-[rgba(199,224,211,0.14)] bg-black/20 px-2 py-3 sm:h-18">
        {bars.map((height, index) => (
          <motion.div
            key={index}
            animate={{ height }}
            transition={{ duration: isMobile ? 0.2 : 0.14, ease: "easeOut" }}
            className="flex-1 self-end rounded-full bg-gradient-to-t from-[#3E5F52] via-[#C7E0D3] to-[#FFF6DE] opacity-95"
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          type="button"
          onClick={togglePlay}
          className="flex h-10 w-10 items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.14)] bg-white/5 text-white transition hover:bg-white/10"
        ...
        <div className="relative h-2 w-full flex-1 overflow-visible rounded-full bg-white/10">
          <div
            className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-[#3E5F52] via-[#C7E0D3] to-[#FFF6DE]"
...
function StructuredCard({ icon: Icon, title, desc, isMobile }) {
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-[rgba(199,224,211,0.10)] bg-gradient-to-l from-white/[0.03] to-white/[0.08] px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.10)] bg-[rgba(198,168,106,0.12)]">
        ...
        <div className="mt-4 rounded-2xl border border-[rgba(199,224,211,0.10)] bg-[rgba(13,24,21,0.58)] px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-[rgba(199,224,211,0.10)] bg-gradient-to-l from-white/[0.03] to-white/[0.08] px-4 py-3">
          ...
          <div
            className={`rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] px-4 py-2 font-bold text-white ${
        ...
        <div
          className={`mt-4 rounded-2xl border border-[rgba(199,224,211,0.10)] bg-[rgba(13,24,21,0.58)] px-4 py-4 text-white/82 ${
            large
...
function ProtectedHlsVideoCard({ video, index, isMobile }) {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[1.4rem] border border-[rgba(199,224,211,0.12)] bg-black/30">
        <video
          ref={videoRef}
        ...
        {!isPlaying && (
          ...
          >
            <span className="flex h-16 w-16 items-center justify-center rounded-full border border-[rgba(255,255,255,0.22)] bg-white/10 backdrop-blur-md shadow-[0_0_32px_rgba(127,160,141,0.22)] sm:h-18 sm:w-18">
              <Play className="ml-1 h-7 w-7 text-white" />
            </span>
          </button>
        )}

        <div className="pointer-events-none absolute left-3 top-3 rounded-full border border-[rgba(199,224,211,0.12)] bg-black/35 px-3 py-1 text-[11px] text-white/80 backdrop-blur-md">
          {!hasStartedLoading
            ? "Appuyez pour lire"
            : isReady
            ? "Prêt à lire"
      ...
      <div className="mt-4 rounded-[1.3rem] border border-[rgba(199,224,211,0.12)] bg-[rgba(13,24,21,0.58)] p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
            className="flex h-10 w-10 items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.12)] bg-white/5 text-white transition hover:bg-white/10"
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <motion.div
          animate={shimmer}
          className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(198,168,106,0.14),transparent_24%),radial-gradient(circle_at_82%_18%,rgba(92,129,112,0.18),transparent_20%),radial-gradient(circle_at_20%_75%,rgba(41,73,60,0.22),transparent_28%),linear-gradient(180deg,#07110D_0%,#0F1A17_34%,#14241E_70%,#1E322B_100%)] bg-[length:140%_140%]"
        />

        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-24 left-1/2 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-[rgba(127,160,141,0.16)] blur-3xl"
              animate={pulseGlow}
            />
            <motion.div
              className="absolute bottom-10 right-10 h-80 w-80 rounded-full bg-[rgba(185,139,115,0.10)] blur-3xl"
              animate={pulseGlow}
            />
        ...
        <div className={containerClass}>
          <header className="pt-4 sm:pt-6">
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[rgba(199,224,211,0.18)] bg-white/10 shadow-[0_0_24px_rgba(127,160,141,0.12)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
              ...
              <nav className="hidden items-center gap-3 md:flex">
                {navItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="rounded-full border border-[rgba(199,224,211,0.10)] bg-white/[0.04] px-4 py-2 text-sm font-medium text-white/85 transition hover:border-[rgba(198,168,106,0.30)] hover:bg-white/[0.08] hover:text-[#F4F0E4]"
                  >
                    {item.label}
                  </a>
                ))}
              ...
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] md:hidden"
              >
                ...
                <div className="grid gap-2">
                  {navItems.map((item) => (
                    <a
                      ...
                      className="rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] px-4 py-3 text-sm text-white/85 sm:text-base"
                    >
                      {item.label}
                    </a>
                  ))}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.03fr_0.97fr] lg:py-20">
            <div className="order-1 lg:order-1">
              <motion.div
                ...
                animate="show"
                variants={fadeUp}
                className="mb-5 inline-flex items-center gap-2 rounded-full border border-[rgba(127,160,141,0.18)] bg-white/[0.06] px-4 py-2 text-xs backdrop-blur-md sm:text-sm"
                style={{ color: ACCENT_SOFT }}
              >
              ...
              >
                <span className="block bg-[linear-gradient(90deg,#FFF7E8_0%,#E8D6B0_38%,#C6A86A_72%,#B98B73_100%)] bg-clip-text text-transparent">
              ...
              >
                <a
                  ...
                  style={{
                    background: "linear-gradient(135deg,#173028 0%, #243B33 100%)",
                    borderColor: "rgba(127,160,141,0.28)",
                    color: ACCENT_SOFT,
                  }}
                >
                  <Sparkles
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center gap-3 rounded-2xl border border-[rgba(199,224,211,0.14)] bg-white/[0.06] px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-md transition hover:border-[rgba(127,160,141,0.22)] hover:bg-white/[0.10] sm:px-7 sm:py-4 sm:text-base"
                >
              ...
              >
                {stats.map((item, i) => (
                  <motion.div
                    ...
                    className="rounded-3xl border border-[rgba(199,224,211,0.10)] bg-white/[0.06] p-3 text-center backdrop-blur-md shadow-[0_10px_24px_rgba(0,0,0,0.20)] sm:p-4"
                  >
                    <div
            ...
            >
              ...
              >
                <div className="rounded-[1.75rem] border border-[rgba(199,224,211,0.10)] bg-[linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-4 sm:p-6">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="w-fit rounded-2xl border border-[rgba(127,160,141,0.22)] bg-[rgba(127,160,141,0.12)] px-4 py-2 text-xs text-[#F6EBD2] sm:text-sm">
                      Diffusion en direct
                    </div>
                  </div>

                  <div className="mt-6 rounded-[1.5rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(13,24,21,0.70)] p-4 sm:mt-8 sm:p-6">
                    <div className="mb-4 flex items-start gap-3 text-sm text-white/80 sm:items-center sm:text-base">
                      <Headphones className="mt-0.5 h-5 w-5 shrink-0 sm:mt-0" style={{ color: ACCENT }} />
                      <span>
                      ...
                      <div className="space-y-3">
                        {[65, 88, 42].map((w, idx) => (
                          <motion.div
                            ...
                            className="h-3 rounded-full bg-gradient-to-r from-[#3E5F52] via-[#C7E0D3] to-[#FFF6DE]"
                          />
                        ))}
                      </div>
                    )}
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-2 text-center sm:mt-8 sm:gap-3">
                      {heroCards.map((item) => (
                        <div
                          key={item.label}
                          className="flex min-h-[108px] flex-col items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] px-2 py-3 sm:min-h-[120px] sm:p-4"
                        >
                          <div
              ...
              <div className="mx-auto mt-5 grid max-w-2xl gap-3 sm:mt-6 sm:flex sm:flex-wrap sm:items-center sm:justify-center sm:gap-4">
                {heroBadges.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="w-full rounded-[1.5rem] border border-[rgba(199,224,211,0.10)] bg-white/[0.06] px-5 py-4 text-center backdrop-blur-md shadow-[0_10px_24px_rgba(0,0,0,0.18)] sm:min-w-[220px] sm:w-auto sm:rounded-[1.6rem]"
                    >
                      <div className="flex items-center justify-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] sm:h-11 sm:w-11">
                          <Icon className="h-5 w-5" style={{ color: ACCENT }} />
                        </div>
          ...
          <section className="py-8 lg:py-12">
            ...
            >
              {!isMobile && (
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(198,168,106,0.08),transparent_28%),radial-gradient(circle_at_80%_80%,rgba(245,230,200,0.06),transparent_32%)]" />
              )}

              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(20,30,26,0.44)] p-4 sm:p-6">
                    <div className="h-full rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4 sm:p-5">
                  ...
                  <div className="rounded-[1.8rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(20,30,26,0.72)] p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4 sm:p-5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-5 inline-flex w-fit items-center gap-2 rounded-2xl border border-[rgba(127,160,141,0.22)] bg-[rgba(127,160,141,0.12)] px-5 py-3 text-sm text-[#F6EBD2] transition hover:bg-[rgba(127,160,141,0.16)] sm:text-base"
                      >
          ...
          <section id="contact" className="py-8 lg:py-12">
            ...
            >
              <div className="text-center">
                <div
                  className="inline-flex max-w-full items-center gap-3 rounded-full border border-[rgba(199,224,211,0.12)] bg-white/[0.06] px-5 py-3 text-base font-semibold backdrop-blur-md shadow-[0_12px_26px_rgba(0,0,0,0.18)] sm:px-7 sm:py-4 sm:text-lg"
                  style={{ color: ACCENT_SOFT }}
                >
                  <Sparkles
              ...
              >
                <div className="rounded-[2rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(20,30,26,0.68)] p-4 sm:p-6">
                  <div className="rounded-[1.5rem] border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4 sm:p-5">
                    ...
                    <div className="space-y-3 text-white/75">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-3 rounded-2xl border border-[rgba(127,160,141,0.22)] bg-[rgba(127,160,141,0.12)] px-4 py-3 text-center text-sm font-semibold text-[#F6EBD2] transition hover:bg-[rgba(127,160,141,0.16)] sm:text-base"
                      >
          ...
          <footer className="pb-8 pt-4 sm:pb-10">
            ...
            >
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                <div
                  className={`rounded-[1.8rem] border border-[rgba(199,224,211,0.10)] p-4 text-center sm:p-6 ${INNER_GRADIENT}`}
                >
                  <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full border border-[rgba(199,224,211,0.14)] bg-white/[0.08] shadow-[0_0_24px_rgba(127,160,141,0.12)] backdrop-blur-md sm:h-24 sm:w-24">
                    <img
                      src={sanaLogo}
                      alt="Logo Sana"
                  ...
                  <div className="mt-4">
                    <span className="inline-flex rounded-full border border-[rgba(199,224,211,0.10)] bg-white/[0.05] px-4 py-2 text-xs text-white/90 sm:px-5 sm:text-sm">
                      Chaînes coraniques Sana
                    </span>
                  </div>
                  ...
                  <p className="mx-auto mt-4 max-w-xl rounded-[1.4rem] border border-[rgba(127,160,141,0.16)] bg-[linear-gradient(135deg,rgba(15,21,37,0.78)_0%,rgba(28,35,54,0.70)_100%)] px-4 py-4 text-sm leading-7 text-white/90 sm:px-5 sm:text-base sm:leading-8">
                ...
                <div className="rounded-[1.6rem] border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4 sm:p-5">
                  ...
                  <div className="space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center gap-3 break-all rounded-2xl border border-[rgba(199,224,211,0.10)] bg-[rgba(13,24,21,0.52)] px-4 py-3 text-sm transition hover:bg-white/[0.08] sm:text-base"
                    >
                      <Mail
                    ...
                    <div className="flex items-center gap-3 rounded-2xl border border-[rgba(199,224,211,0.10)] bg-[rgba(13,24,21,0.52)] px-4 py-3 text-sm sm:text-base">
                      <MapPin
                        className="h-4 w-4 shrink-0"
                        style={{ color: ACCENT }}
                      />
                  ...
                  <div className="mt-5 rounded-[1.4rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(18,29,25,0.46)] p-4">
                    <a
                      href="https://www.facebook.com/share/1FVbmggbzc/"
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center justify-center gap-2 rounded-xl border border-[rgba(199,224,211,0.10)] bg-white/[0.04] py-3 text-sm font-semibold text-white transition hover:scale-[1.01] hover:bg-white/[0.08]"
                    >
                ...
                <div className="rounded-[1.8rem] border border-[rgba(199,224,211,0.10)] bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-4 backdrop-blur-md sm:p-5">
                  ...
                  <div className="rounded-[1.4rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(18,29,25,0.46)] p-4">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group rounded-[1.3rem] border border-[rgba(199,224,211,0.10)] bg-white/[0.04] p-4 transition hover:-translate-y-0.5 hover:bg-white/[0.08]"
                      >
                        <div className="flex items-center justify-between gap-3">
                          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[rgba(199,224,211,0.10)] bg-[rgba(127,160,141,0.12)] text-white">
                            <GooglePlayIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-[rgba(199,224,211,0.10)] bg-[rgba(18,31,26,0.62)] p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-[rgba(127,160,141,0.22)] bg-[rgba(127,160,141,0.12)] py-3 text-sm font-bold text-[#F6EBD2] transition hover:scale-[1.01] hover:bg-[rgba(127,160,141,0.16)]"
                      >
              ...
              <div className="mt-8 border-t border-[rgba(199,224,211,0.10)] pt-5 text-center text-xs text-white/55 sm:text-sm">
