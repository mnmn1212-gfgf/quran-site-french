...
function ProtectedHlsVideoCard({
  ...
  useEffect(() => {
    ...
    const onLoaded = () => {
      ...
      setIsReady(true);
      requestAnimationFrame(capturePosterFrame);
    };
    ...
    element.addEventListener("seeked", capturePosterFrame);
    ...
    return () => {
      ...
      element.removeEventListener("seeked", capturePosterFrame);
    };
  ...
  const playVideo = () => {
    ...
    if (activeVideoId !== null && activeVideoId !== video.id) {
      onActivate(video.id);
    }
